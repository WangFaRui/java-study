package com.wray.thrid.dingtalk.frame.client;
...
import com.wray.thrid.dingtalk.frame.DingTalkAuthManager;
...
import com.wray.thrid.dingtalk.frame.config.DingTalkURLConstant;
import com.wray.thrid.dingtalk.frame.form.ApprovalFormEngine;
import com.wray.thrid.dingtalk.frame.model.ApprovalFormInstance;
import com.wray.thrid.dingtalk.frame.model.entity.DdApprovalFormRel;
import com.wray.thrid.dingtalk.frame.model.entity.DdUserRel;
import com.wray.thrid.dingtalk.frame.util.DingTalkApiClientUtil;
...
public class DingTalkWorkflowClient {
    ...
    public static GetAttachmentSpaceResponseBody.GetAttachmentSpaceResponseBodyResult getAttachmentSpace() {
        ...
        GetAttachmentSpaceRequest getAttachmentSpaceRequest = new GetAttachmentSpaceRequest()
                .setUserId(DingTalkConfig.getTenantPropertiesValue(DingTalkTenantProperties::getUserId))
                .setAgentId(DingTalkConfig.getTenantPropertiesValue(DingTalkTenantProperties::getAgentId));
     ...
     * @return processCode
     */
    public static String saveOrUpdateApprovalForm(ApprovalFormEngine approvalForm, String processCode) {
        // 请求头
    ...
    public static boolean authorizeApprovalDentry(List<String> fileIdList) {
        Client client = DingTalkApiClientUtil.createWorkflowClient();
