...
import com.wray.thrid.dingtalk.frame.util.UserUtils;
import lombok.Data;
...
public class ApprovalFormInstance {
    ...
    public ApprovalFormInstance() {
    }

    public ApprovalFormInstance(Long businessId, ApprovalFormEngine approvalForm,
    ...
    public static class ApprovalFormInstanceBuilder {
        ...
        public ApprovalFormInstanceBuilder approvalForm(ApprovalFormEngine approvalForm) {
            this.approvalForm = approvalForm;
            return this;
        }
        ...
        public ApprovalFormInstance build() {
            return new ApprovalFormInstance(businessId, approvalForm, tenantId, userId, departmentId);
        }
    }
}
