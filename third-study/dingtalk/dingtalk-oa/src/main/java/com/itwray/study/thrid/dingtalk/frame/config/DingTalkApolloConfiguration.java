...
import com.itwray.study.thrid.dingtalk.frame.runner.AbstractDingTalkApplicationRunner;
 ...
 */
@Slf4j
public class DingTalkApolloConfiguration implements EnvironmentAware, ApplicationContextAware {
    ...
    public void init() {
        ...
        DingTalkConfig.putTenantProperties(this.convertProperty(property));
    }
    ...
    public void apolloListener(ConfigChangeEvent changeEvent) {
        ...
        DingTalkConfig.cleanTimerCache();
        DingTalkConfig.putTenantProperties(this.convertProperty(configChange.getNewValue()));
        try {
            applicationContext.getBean(AbstractDingTalkApplicationRunner.class).innerRun();
